...
export default function HomePage(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20'>
            ...
            sm:text-6xl md:text-7xl'>ML<span className='text-blue-800 bold'>App</span></h1>
            ...
            className='flex specialBtn px-4 py-2 
            ...
            className='text-blue-800 cursor-pointer
             hover:text-blue-900 duration-200'>upload <input onChange={(e) => {
                const tempFile = e.target.files[0]
                setFile(tempFile)
            }} className='hidden' type='file' accept='.mp3,.wave' /></label> a mp3 file</p>
            <p className='text-blue italic text-slate-300'>Free now free forever</p>
        </main>
    )
}